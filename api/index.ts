...
// Initialize Supabase lazily or conditionally
...
// CRON Endpoint for external services (like cron-job.org) to ping every minute
    ...
    for (const userId in data.users) {
      ...
      for (const m of upcomingMeetings) {
        ...
        if (!hasTags) {
          ...
          // Send ONLY to subscribers matching the tags
...
// Export the Express app to be used as a serverless function by Vercel
export default app;
